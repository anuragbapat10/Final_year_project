    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="content-wrapper">
              ...
              @php
                $issue_req = \Illuminate\Support\Facades\Http::get('http://localhost:8001/api/issue/' . $id);
                $issue = $issue_req['data'];
              @endphp
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            ...
                            <h4 class="fw-bold py-3 mb-4">
                                <span class="text-muted fw-light">Issues /</span> {{$issue['title']}}
                            </h4>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card mb-4">
                                        <h5 class="card-header">Issue </h5>

                                        <div class="card-body">
                             <h5 class="card-title"> Name: &nbsp; {{$issue['title']}}</h5>
                             <div class="card-subtitle text-muted mb-3"><b>Tags: &nbsp; &nbsp;</b>
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="comment__container opened" id="first-comment">
                                           <div class="comment__card">
                                             ...
                                             <div>Likes {{$issue['desc_comment']['upvote']}}</div>
                                             <div>Dislikes {{$issue['desc_comment']['downvote']}}</div>
                                             <div class="show-replies">Reply 2</div>
                                             </div>
                                          </div>
                                            <div class="comment__container" dataset="first-comment" id="first-reply">
                                              <div class="comment__card">
                                                <p>comment 1 Reply 1</p>
                                                <div class="comment__card-footer">
                                                  <div>Likes 123</div>
                                                  <div>Dislikes 23</div>
                                              ...
                                              >
                                                ...
                                                <div class="comment__container" dataset="first-first-reply">
                                                  <div class="comment__card">
                                                    ...
                                                    <p>
                                                    Comment 1 > reply 1> reply 1> reply 1
