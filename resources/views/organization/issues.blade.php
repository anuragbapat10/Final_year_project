                        ...
                        <div class="card">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row gx-3 gy-2 align-items-center">
                                        <div class="col-md-3">
                                            <label class="form-label" for="selectTypeOpt">Assignee</label>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <button id="showToastPlacement" class="btn btn-primary d-block">Search
                                            </button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive text-nowrap">
                                ...
                                <table class="table">
                                    ...
                                    @endphp
                                    <tr>
                                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{$issue["id"]}}</strong>
                                        </td>
                                        <td>{{$issue["title"]}}</td>
